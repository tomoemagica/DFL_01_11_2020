...
class Model(ModelBase):
    ...
    def predictor_func (self, face=None, dummy_predict=False):
        if dummy_predict:
            self.src_view ([ np.zeros ( (1, 256, 256, 3), dtype=np.float32 ) ])
        else:
    ...
    def get_ConverterConfig(self):
        import converters
        return self.predictor_func, (256,256,3), converters.ConverterConfigMasked(face_type=FaceType.HALF, default_mode='seamless')
